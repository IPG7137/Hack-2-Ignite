...
export const INITIAL_MOCK_COMPLAINTS: Complaint[] = [
  {
    ...
    location: {
      address: "Crossroad of FC Road & Fergusson College Gate 3",
      landmark: "Opposite Deccan Post Office",
      ward: "Ward 08 - Deccan Gymkhana",
      zone: "Zone 2 (Central West)",
      latitude: 18.5218,
      longitude: 73.8415,
    },
    status: "in_progress",
    ...
    assignment: {
      ...
      contractorName: "L&T Municipal Urban Roadways Infra",
    ...
    statusHistory: [
      ...
      },
      {
        ...
        notes: "Dispatched Quick Patch Unit #4 under Contractor L&T Infra.",
      },
      {
        id: "SH-4",
        fromStatus: "assigned",
    ...
    adminNotes: [
      {
        id: "AN-1",
        author: "K. V. Patil (EE)",
        text: "Traffic police notified to redirect heavy vehicles through Law College road during curing.",
  ...
  },
  {
    ...
    location: {
      address: "Lane 4, Koregaon Park North Main Road",
      landmark: "Near German Bakery Corner",
      ward: "Ward 14 - Koregaon Park / Bund Garden",
      zone: "Zone 1 (Central East)",
      latitude: 18.5362,
      longitude: 73.8895,
    },
    status: "assigned",
    ...
    assignment: {
      ...
      contractorName: "Jal Seva Municipal Works Corp",
  ...
  },
  {
    ...
    location: {
      address: "Near Ganpati Chowk, Kothrud",
      landmark: "Adjacent to PMC Primary School #12",
      ward: "Ward 22 - Kothrud South",
  ...
  },
  {
    ...
    location: {
      address: "Katraj-Dehu Road Bypass Stretch, Near Navale Bridge",
      landmark: "Pillars 18 to 28",
      ward: "Ward 31 - Ambegaon / Katraj",
      zone: "Zone 4 (South)",
      latitude: 18.4574,
      longitude: 73.8344,
    },
  ...
  },
  {
    ...
    location: {
      address: "Prabhat Road, Lane 11, Erandwane",
      landmark: "Opposite Balshikshan Mandir School",
      ward: "Ward 10 - Erandwane",
      zone: "Zone 2 (Central West)",
      latitude: 18.5109,
      longitude: 73.8322,
    },
  ...
  },
  {
    ...
    location: {
      address: "University Circle Roundabout, Ganeshkhind Road",
      landmark: "Near Raj Bhavan Main Entrance Gate",
      ward: "Ward 07 - Aundh / University",
      zone: "Zone 2 (Central West)",
      latitude: 18.5411,
      longitude: 73.8291,
    },
  ...
  },
  {
    ...
    location: {
      address: "Bhandarkar Road, Lane 7",
      landmark: "Outside Shanti Kunj Apartments",
      ward: "Ward 09 - Shivaji Nagar / Model Colony",
      zone: "Zone 2 (Central West)",
      latitude: 18.5245,
      longitude: 73.8378,
    },
    ...
    statusHistory: [
      ...
      },
      {
        ...
        notes: "Hazmat crew deployed with multi-gas detector. MNGL gas pipeline engineers alerted.",
      }
    ],
    adminNotes: [
      {
        ...
        text: "Methane level 420ppm detected. Water flushing underway while MNGL inspects underground gas main.",
    ...
    aiClassification: {
      ...
      summary: "Critical toxic vapor escape. Multi-agency Hazmat & Gas utility response activated.",
      clusterAnomalyDetected: false,
    },
    sla: {
      targetHours: 6,
  ...
  },
  {
    id: "CR-2026-108",
    dbId: 108,
    title: "Illegal Construction Debris Dumped on Riverbed Bank",
    description: "Over 8 truckloads of reinforced concrete rubble and masonry illegally unloaded onto Mula-Mutha river green belt overnight.",
    category: "waste_management",
    categoryLabel: "Public Health & Sanitation",
    location: {
      address: "Mundhwa Riverbank Approach, Near Kharadi Bridge",
      landmark: "Kharadi-Mundhwa Bypass Ghat",
      ward: "Ward 18 - Kharadi / Mundhwa",
      zone: "Zone 5 (East)",
      latitude: 18.5398,
      longitude: 73.9312,
    },
    ...
    priority: "high",
    reporter: {
      name: "Anand Shelar (Green Pune Forum)",
    ...
    aiClassification: {
      ...
      hazardKeywords: ["riverbed", "debris", "floodplain encroachment", "environmental crime"],
      summary: "Massive illegal C&D waste dumping on river buffer zone. NGT guidelines violation.",
      clusterAnomalyDetected: true,
  ...
  },
  {
    id: "CR-2026-109",
    dbId: 109,
    title: "Cracked Water Hydrant Flooding Basement Ramp",
    ...
    categoryLabel: "Water Supply Pipeline",
    location: {
      address: "Senapati Bapat Road, Opposite ICC Trade Tower",
  ...
  },
  {
    ...
    description: "Perforated metal tread plate corroded through on central pedestrian staircase. Foot can slip through gap directly over expressway.",
    category: "roads",
    categoryLabel: "Roads & Pavements",
    location: {
      address: "Swargate Pedestrian Skywalk Staircase #3",
      landmark: "Near Swargate Bus Terminal Metro Station",
      ward: "Ward 12 - Swargate / Parvati",
      zone: "Zone 3 (South West)",
      latitude: 18.5018,
      longitude: 73.8582,
    },
